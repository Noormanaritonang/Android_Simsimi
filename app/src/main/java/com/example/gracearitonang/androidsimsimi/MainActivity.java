package com.example.gracearitonang.androidsimsimi;
...
import com.example.gracearitonang.androidsimsimi.Adapter.CustomAdapter;
import com.example.gracearitonang.androidsimsimi.Helper.HttpDataHandler;
import com.example.gracearitonang.androidsimsimi.Models.ChatModel;
import com.example.gracearitonang.androidsimsimi.Models.SimsimiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class SimsimiAPI extends AsyncTask<List<ChatModel>,Void,String>{
        ...
        protected String doInBackground(List<ChatModel>... params) {
            ...
            models = params[0];//http://sandbox.api.simsimi.com/request.p?key=your_trial_key&lc=en&ft=1.0&text=hi
        ...
        protected void onPostExecute(String s) {
            ...
            ChatModel chatModel = new ChatModel(response.getResponse(), false); // untuk mendapatkan response dari simsimi
